...
The pattern with soil humidity is also counter-intuitive (but soil humidity is very positively correlated with maximum temperature).
...
-   soil variables related to productivity =\> we see below that higher bulk density is (weakly) related to to longer duration of over-productivity, and over-productivity last less time in soil with higher clay content.
This could  support the hypotheses that over-productivity lasts longer in less fertile soils. But there is no pattern with SOC...
