...
Launch the [`make.R`](https://github.com/cpiponiot/Demography/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/cpiponiot/Demography/blob/main/CONTRIBUTING.md).
