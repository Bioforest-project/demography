...
**Demography** is a subproject of the Bioforest project aimed at studying the interactions between tree biodiversity, forest dynamics and climate in managed tropical forests with a pan-tropical approach. The subproject **Demagraphy** aims to investigate the role of demographic processes in explaining post-logging changes in biodiversity and composition. Its main research questions are: 
...
- How do abiotic factors and pre-logging biodiversity shape demographic processes of recovery?

The core group is composed of Camille Piponiot, Géraldine Derroire, Euridice Honorio, Dwinda Putri, and Irié Zo-Bi. 
...
-   [`analyses/`](https://github.com/Bioforest-project/Demography/tree/main/analyses):
    contains scripts used for data analysis and for creating figures and outputs
