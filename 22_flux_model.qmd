...
## Integrating flux values over the census interval
...
Current version of the model is as follows (06/05/2026):

Productivity: $OverProd_{p,t} = \omega_s \cdot AGB_{p,t} + \delta_p \cdot \left( \frac{t}{\tau_s} \cdot exp(1-\frac{t}{\tau_s}) \right)^{\kappa_s}$

Mortality: $OverMort_{p,t} = \omega_s \cdot AGB_{p,t} + \alpha_p \cdot exp(-\lambda_s \cdot t)$
