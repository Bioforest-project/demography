...
# Demography <img src="man/figures/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/cpiponiot/Demography/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/cpiponiot/Demography/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/cpiponiot/Demography/tree/main/R):
